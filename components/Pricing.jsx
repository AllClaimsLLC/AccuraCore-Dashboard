...
// const API_URL =
//   "https://accuracore-payment-api-a4atg5awdzazfdh6.centralus-01.azurewebsites.net/api/subscription-plans?activeOnly=true";

// const SERVICE_KEY =
//   "e487c4869f7ea79a52f53ab0218738f9ed048affda074f0d6db1a7eee8aa982d";
...
//   const mergedPlans = plans.map((hardcodedPlan) => {
//     const apiPlan = apiPlans.find(
//       (p) => p.code?.toLowerCase() === hardcodedPlan.code?.toLowerCase(),
//     );

//   return {
//   ...hardcodedPlan,

//   name: apiPlan?.name ?? null,

//   id: apiPlan?.id ?? null,
//   amount: apiPlan?.amount ?? hardcodedPlan.base,
//   baseAmount: apiPlan?.baseAmount ?? hardcodedPlan.base,
//   perUserAmount:
//     apiPlan?.perUserAmount ??
//     parseInt(hardcodedPlan.perUser.replace("$", "")),
...
//             const Icon = plan.icon;
//             const price = plan.amount || plan.base;
...
//                       +{" "}
//                       <span className="text-black font-medium">
//                         ${plan.perUserAmount || plan.perUser.replace("$", "")}
//                       </span>
//                       <br />
//                       per user
//                     </div>
...
//                     if (plan.id) {
//                       router.push(
//                         `https://accura-core-env-staging-sparx-technologies-projects.vercel.app/signup?planId=${plan.id}`,
//                       );
//                     }
//                   }}
//                 >
