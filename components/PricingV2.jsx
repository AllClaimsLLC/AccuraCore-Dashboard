...
export default function PricingV2({ setIsOpen }) {
  useFadeIn();
  ...
  <span className="text-[18px] font-medium text-gray-500 self-end mb-1">
    /mo
              ...
              >
                <Image
                  src="/Icons/PricingPage/pricing-star.svg"
                  alt=""
                  width={15}
                  height={15}
                ...
                <p className="text-[13.5px] text-gray-600 leading-snug">
                  Add <span className="text-[#FA8C3D]">MyAccuraCore</span>{" "}
                  customer communication for just{" "}
