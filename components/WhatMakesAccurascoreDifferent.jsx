...
//             {/* Unified Cards Grid — 4 per row, equal height */}
...
//                     key={idx}
//                     {...wrapperProps}
//                     className="group relative overflow-hidden rounded-[12px] md:rounded-[15px] p-4 md:p-6 flex flex-col h-full gap-4 cursor-pointer bg-white dark:bg-slate-900 shadow-lg transition-transform duration-500 ease-out hover:scale-[1.03]"
//                   >
//                     {/* Background image */}
//                     <div
