        ...
        <div className="max-w-[90%] mt-0 sm:mt-20 md:mt-20 lg:mt-20 mb-20 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-3xl text-[black]">
              Why This Isn’t
              <br className="hidden lg:block" /> Just Task Management.
            </h1>

            {/* BOX 1 */}
            <div className="bg-[#f2f1ef] rounded-[20px] p-6 flex flex-col gap-4">
              <h3 className="text-black font-semibold">
                Most Measurement Tools
              </h3>
          ...
          <div className="pt-10 mb-15 flex flex-col gap-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              <AccuraCard
                title={
                  <>
                    Eliminates Stalled Jobs <br className="hidden lg:block" />{" "}
                    Which Results In:
                  </>
                }
                bullets={[
                ...
                image="/Images/EliminatesStalledJobsWhichResultsIn.png"
                alt="Eliminates Stalled Jobs"
              />

              <AccuraCard
                title={
                  <>
                    Prevents Skipped Steps & Confusion{" "}
                ...
                image="/Images/PreventsSkippedStepsPreventsWhichResultsIn.png"
                alt="Prevents Skipped Steps"
              />
              ...
              <AccuraCard
                ...
                image="/Images/ReducesInternalCoordinationWhichResultsIn.png"
                alt="Internal Coordination"
              />
            </div>
          </div>
          ...
          <div className="space-y-6 text-center md:text-left">
            <h2 className="text-2xl md:text-4xl font-[400] leading-tight text-black">
              <span className="text-[#FA8C3D]">
                Stop Relying on Manual Follow-Ups.{" "}
              </span>
              Let the Workflow Run the Job.
            </h2>
